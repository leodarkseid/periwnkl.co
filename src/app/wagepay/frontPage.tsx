...
import ContractSVG from "../../../public/contract.svg";
      ...
      >
        <GridItem>
          <Flex as="div" display="flex" flexDirection="column">
            ...
            >
              A Simple Wage Manager, that automates wage payment and also
              assures Employees of Payment for at least One Payment Cycle
            </Text>
